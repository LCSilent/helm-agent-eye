...
func (a *Analyzer) AnalyzeCronJob(r common.Request) (string, error) {
	kind := "CronJob"
	...
	cronJobList, err := a.k8s.Clientset.BatchV1().CronJobs(r.Namespace).List(r.Context, metav1.ListOptions{})
	if err != nil {
		return "", err
	}
